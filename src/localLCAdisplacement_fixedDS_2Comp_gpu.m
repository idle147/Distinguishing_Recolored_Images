...
function [Dhat1,Dhat2, iCC, niter] = localLCAdisplacement_fixedDS_2Comp_gpu(I,iRC,C,hW,u,delta)
...
for iComp = 1:2;
    %Get windowed data from image
    Icomp_win = gpuArray(double(I(jnds_CompWin,inds_CompWin,iCC(iComp))));
    %upsample
